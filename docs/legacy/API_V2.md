# UIFlow Code Generator API V2 接口文档（Legacy）

> V2 已由 [API_V3.md](../API_V3.md) 取代。根目录 `server_v2.py` 启动 V3 服务；旧实现位于 `legacy/v2/server_v2.py`。新网页客户端不要继续接入本协议。

> 本文档面向下游调用方，对应 `legacy/v2/server_v2.py`。
